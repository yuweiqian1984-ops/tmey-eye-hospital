...
export default function CataractPage() {
  const dept = departments.find(d => d.id === "cataract");
  if (!dept) return null;
    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="pt-24 pb-16 bg-gradient-to-br from-blue-700 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          ...
          <p className="text-xl text-white/80">开启无刀治疗白内障时代</p>
        </div>
      </div>
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2">
              ...
              <h2 className="text-2xl font-bold text-gray-900 mb-6">治疗优势</h2>
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                <div className="bg-blue-50 rounded-xl p-6">
                  <div className="text-3xl mb-3">⚡</div>
                  <h3 className="font-bold text-gray-900 mb-2">手术时间短</h3>
                  <p className="text-gray-600 text-sm">采用美国爱尔康超声乳化仪，手术仅需10-15分钟</p>
                </div>
                <div className="bg-blue-50 rounded-xl p-6">
                  <div className="text-3xl mb-3">🛡️</div>
                  <h3 className="font-bold text-gray-900 mb-2">安全性高</h3>
                  <p className="text-gray-600 text-sm">切口小、恢复快，术后感染风险低</p>
                </div>
                <div className="bg-blue-50 rounded-xl p-6">
                  <div className="text-3xl mb-3">👁️</div>
                  <h3 className="font-bold text-gray-900 mb-2">视觉质量优</h3>
                  <p className="text-gray-600 text-sm">可植入多焦点晶体，术后脱镜率高</p>
                </div>
                <div className="bg-blue-50 rounded-xl p-6">
                  <div className="text-3xl mb-3">💰</div>
                  <h3 className="font-bold text-gray-900 mb-2">医保报销</h3>
                  <p className="text-gray-600 text-sm">枣庄市医保定点医院，费用可报销</p>
                </div>
              </div>
              ...
              <div className="mt-10 p-6 bg-blue-50 rounded-xl">
                <h3 className="font-bold text-blue-900 mb-2">白内障咨询预约电话</h3>
            ...
            <div className="space-y-6">
              <div className="bg-gray-50 rounded-xl p-6 border">
                ...
                <ul className="space-y-2">
                  {departments.map((d) => (
                    <li key={d.id}>
                      <Link href={`/departments/${d.id}`} className={`text-sm hover:text-blue-600 ${d.id === "cataract" ? "text-blue-600 font-semibold" : "text-gray-600"}`}>
                        · {d.name}
                      </Link>
                    </li>
                  ))}
              ...
              <div className="bg-gradient-to-br from-blue-600 to-teal-600 rounded-xl p-6 text-white">
                ...
                <p className="text-white/80 text-sm mb-4">了解白内障手术详情</p>
