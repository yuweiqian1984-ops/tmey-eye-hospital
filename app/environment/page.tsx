...
import { hospitalInfo, environmentPhotos } from "../../lib/data";
        ...
        <div className="max-w-7xl mx-auto px-4">
          <div className="flex items-center justify-between h-16">
            ...
            <div className="hidden md:flex items-center gap-8">
              ...
              <Link href="/environment" className="text-blue-600 font-medium text-sm">温馨环境</Link>
      ...
      <div className="pt-24 pb-16 bg-gradient-to-br from-blue-700 to-teal-600 text-white">
        <div className="max-w-7xl mx-auto px-4">
          <div className="breadcrumb text-white/70 mb-4">
            <Link href="/" className="hover:text-white">首页</Link> &gt; 温馨环境
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">温馨环境</h1>
          <p className="text-xl text-white/80">温馨舒适 · 专业诊疗 · 温馨环境</p>
        </div>
      </div>
