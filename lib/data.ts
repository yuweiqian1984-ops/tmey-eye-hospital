...
export const doctors: Doctor[] = [
  ...
  },
  {
    ...
    credentials: ["国际角膜塑形学会亚洲分会(IAOA)会员", "中国视觉发展与康复工作组(VDT)会员"],
...
export const equipment: Equipment[] = [
  { name: "VisuMax全飞秒设备", category: "屈光手术" },
  { name: "阿玛仕SMART全激光屈光手术设备", category: "屈光手术" },
  { name: "德国蔡司Clarus500眼底相机", category: "检查设备" },
  { name: "德国蔡司IOL Master700生物测量仪", category: "检查设备" },
  { name: "法国光太YAG前节激光仪", category: "激光设备" },
  { name: "法国光太眼底激光治疗仪", category: "激光设备" },
  { name: "纳焦飞秒近视手术设备", category: "屈光手术" },
  { name: "拓普康综合验光仪", category: "检查设备" },
  { name: "法国光太A/B超", category: "检查设备" },
  { name: "德国海德堡眼底血管造影仪", category: "检查设备" },
  { name: "德国海德堡OCT", category: "检查设备" },
  { name: "美国爱尔康超声乳化仪", category: "手术治疗" },
  { name: "德国莱卡显微镜", category: "手术治疗" },
  { name: "百级层流手术室", category: "手术室" },
];
...
export const departments: Department[] = [
  {
    ...
    articles: [
      ...
      { title: "不同人群怎么选近视手术？学生、上班族、高龄各有讲究" },
      { title: "近视手术安全吗？关于风险、反弹、后遗症你必须知道" },
      { title: "做近视手术前，为什么要先做一整套眼科检查" },
      { title: "近视手术方式有哪几种？全飞秒、半飞秒、全激光对比" },
      { title: "全飞秒3.0和4.0的区别" },
      { title: "白领常用电脑能做近视手术吗" },
      { title: "全飞秒术后注意事项" },
      { title: "纳焦飞秒近视手术" },
...
export const news = [
  { title: "学术资讯 | 第二届启明医疗屈光白内障手术研讨会圆满召开", date: "2022-09-03", excerpt: "专家云集，共话学术晶彩，名医荟萃，共襄眼科未来。" },
  ...
  { title: "滕州市万步有约健步激励大赛总结表彰会举行", date: "2021-12-20" },
  { title: "济宁市医养结合协会来我院考察", date: "2021-11-15" },
];

export const features = [
  { title: "近视手术", subtitle: "全方位治近视 助您轻松摘镜", icon: "refractive" },
  { title: "超声乳化治疗白内障", subtitle: "开启无刀治疗白内障时代", icon: "cataract" },
  { title: "小儿弱视早治效果佳", subtitle: "让孩子眼睛亮起来", icon: "pediatric" },
];

export const hospitalIntro = `滕州启明眼科医院是枣庄地区按三级标准建设的专业眼科医院，是枣庄市医保定点医院，是视力残疾精准康复指导站，是慈善光明行动定点医院，是中小学近视防控基地。2019年9月获评全国首家雷锋医院和全国学雷锋活动基地等荣誉称号。

医院全套引进世界同步的眼科检查、治疗设备，引进国内高水平眼科专业人才，特邀国内知名眼科专家定期来院坐诊、手术。

医院设有屈光专科、白内障科、眼底科、青光眼科、小儿眼科、干眼科、视光中心等科室，开放床位50张。
...
export const environmentPhotos = [
  ...
  { src: "https://www.tzqmyk.com/upload_files/article/327/12_20170724140707_0gmzo.jpg", alt: "医院大楼" },
  { src: "https://www.tzqmyk.com/upload_files/article/327/12_20260916140950_u2bed.jpg", alt: "挂号收费处" },
];
